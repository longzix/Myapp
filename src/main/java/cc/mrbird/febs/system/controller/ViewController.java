...
public class ViewController extends BaseController {
    ...
    @GetMapping(FebsConstant.VIEW_PREFIX + "system/que")
    @RequiresPermissions("que:view")
    public String systemQue() {
        return FebsUtil.view("system/que/que");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "system/que/add")
    @RequiresPermissions("que:add")
    public String systemQueAdd() {
        return FebsUtil.view("system/que/queAdd");
    }
    /**
     * ----------------------------------------------------------------------------------------------
     * @return
